...
ORDER BY vendor_type, market_date; 
...
SELECT DISTINCT v.vendor_id, vendor_name, 

COUNT (v.vendor_id) as booth_count 
...
VALUES ('10', 'Thomas Super Foods', 'Fresh Focused', 'Thomas', 'Rosenthal');
